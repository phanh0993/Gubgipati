...
const MobileLoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Lưu thông tin user vào localStorage - dùng key riêng cho mobile
      localStorage.setItem('mobile_employee', JSON.stringify(loginData.user));
      // Cũng lưu vào pos_employee để tương thích với các page khác
      localStorage.setItem('pos_employee', JSON.stringify(loginData.user));
      console.log('✅ [Mobile Login] Saved employee to localStorage:', loginData.user.fullname || loginData.user.full_name);
